...
type ChatroomResolver interface {
	Messages(ctx context.Context, obj *chat.Chatroom) ([]*Message, error)
}
type MutationResolver interface {
	Post(ctx context.Context, text string, username string, roomName string) (*Message, error)
}
type QueryResolver interface {
	Room(ctx context.Context, name string) (*chat.Chatroom, error)
}
...
func (ec *executionContext) _Chatroom_name(ctx context.Context, field graphql.CollectedField, obj *chat.Chatroom) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Chatroom_messages(ctx context.Context, field graphql.CollectedField, obj *chat.Chatroom) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Chatroom().Messages(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚕᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*chat.Chatroom)
	fc.Result = res
	return ec.marshalOChatroom2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚋchatᚐChatroom(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_messageAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNMessage2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) _Chatroom(ctx context.Context, sel ast.SelectionSet, obj *chat.Chatroom) graphql.Marshaler {
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋkhanakiaᚋchatexampleᚐMessage(ctx context.Context, sel ast.SelectionSet, v Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []*Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOChatroom2ᚖgithubᚗcomᚋkhanakiaᚋchatexampleᚋchatᚐChatroom(ctx context.Context, sel ast.SelectionSet, v *chat.Chatroom) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
